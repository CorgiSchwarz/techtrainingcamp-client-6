...
class ClockPageState extends State<ClockPage> {
  ...
  // A Raised button that is customized to show myPosition Time when clicked
  Widget _areaButtonChina(context, String label) {
    return RaisedButton(
      onPressed: () {
        if (label == 'INDIA') {
          myPosition = !myPosition;
          ...
          Padding(
            ...
            child: Row(
              ...
              children: <Widget>[
                ...
                Container(child: _areaButtonChina(context, "My Position")),
              ],
            ),
          ),
        ],
